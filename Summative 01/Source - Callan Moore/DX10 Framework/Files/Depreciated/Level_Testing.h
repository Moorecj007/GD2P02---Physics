...
// Inclusion Guards
#pragma once
#ifndef __LEVEL_TESTING_H__
#define __LEVEL_TESTING_H__
...
public:
	...
	********************/
	Level_Testing(GDI_Renderer* _pGDI_Renderer, int _clientWidth, int _clientHeight);
